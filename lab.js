...
let favoriteThings = {
  ...
  food: 'Fried pickels',
  person: 'Elon Musk',
  book: 'Hitlers Monsters',
  movie: 'The Man Who Knew Too Little',
  holiday: 'Christmas'
}
favoriteThings.car = 'New Yorker'
favoriteThings.show = 'A Christmas Carol'
...
/*
  ...
  Use ob
  ject destructuring to save the property values to new variables.
...
let myCat = new Cat ('bill', 5, 'color')
...
let gandolf = new Wizard ('gandolf', '10000', 'poof')
...
class Phone {
  constructor(brand, model, storage, color, price, soldProperties) {
    ...
    return `${brand},${model},${false},${storage},${color},${price},${soldProperties}`
  }
    sell() {
...
// let myFirstPhone = new Phone("Apple", "11 Pro Max", 25, "green", 500);
//  console.log(changePrice());
//    let mySecondPhone = new Phone("Apple", "SE", 30, "black", 450);
//     console.log();
//       let myThirdPhone = new Phone("Apple", "IphoneX", 60, "Jet Black", 400); 
//       console.log(); 
